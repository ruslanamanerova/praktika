import { UniqueComponentId, ObjectUtils, DomHandler } from '@primevue/core/utils';
...
var script = {
  ...
  methods: {
    ...
    updateListScroll: function updateListScroll(listElement) {
      var listItems = DomHandler.find(listElement, '[data-pc-section="item"][data-p-selected="true"]');
