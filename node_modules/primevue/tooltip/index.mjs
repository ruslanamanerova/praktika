import { UniqueComponentId, ObjectUtils, ConnectedOverlayScrollHandler, DomHandler, ZIndexUtils } from '@primevue/core/utils';
...
var Tooltip = BaseTooltip.extend('tooltip', {
  ...
  methods: {
    ...
    create: function create(el) {
      ...
      var container = DomHandler.createElement('div', _defineProperty(_defineProperty({
