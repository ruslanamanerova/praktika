import { UniqueComponentId, ZIndexUtils, DomHandler, ConnectedOverlayScrollHandler } from '@primevue/core/utils';
...
var script = {
  ...
  methods: {
    ...
    scrollValueInView: function scrollValueInView() {
      if (this.overlay) {
        var selectedItem = DomHandler.findSingle(this.overlay, '[data-p-selected="true"]');
        if (selectedItem) {
