...
var script = {
  ...
  mounted: function mounted() {
    if (this.$el) {
      ...
      var stepElements = DomHandler.find(this.$pcStepper.$el, '[data-pc-name="step"]');
      var stepPanelEl = DomHandler.findSingle(this.isVertical ? (_this$$pcStepItem = this.$pcStepItem) === null || _this$$pcStepItem === void 0 ? void 0 : _this$$pcStepItem.$el : (_this$$pcStepList = this.$pcStepList) === null || _this$$pcStepList === void 0 ? void 0 : _this$$pcStepList.$el, '[data-pc-name="step"]');
      var stepPanelIndex = ObjectUtils.findIndexInList(stepPanelEl, stepElements);
