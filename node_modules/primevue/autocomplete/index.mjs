import { UniqueComponentId, ZIndexUtils, ObjectUtils, DomHandler, ConnectedOverlayScrollHandler } from '@primevue/core/utils';
  ...
  methods: {
    ...
    hide: function hide(isFocus) {
      ...
      var _hide = function _hide() {
        ...
        isFocus && DomHandler.focus(_this2.multiple ? _this2.$refs.focusInput : _this2.$refs.focusInput.$el);
      };
      setTimeout(function () {
        _hide();
      }, 0); // For ScreenReaders
