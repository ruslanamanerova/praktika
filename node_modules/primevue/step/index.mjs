import { ObjectUtils, DomHandler } from '@primevue/core/utils';
...
var script = {
  ...
  mounted: function mounted() {
    if (this.$el && this.$pcStepList) {
      var index = ObjectUtils.findIndexInList(this.$el, DomHandler.find(this.$pcStepper.$el, '[data-pc-name="step"]'));
      var stepLen = DomHandler.find(this.$pcStepper.$el, '[data-pc-name="step"]').length;
