import { UniqueComponentId, DomHandler } from '@primevue/core/utils';
    ...
    if (binding.oldValue !== binding.value) {
      ...
      if (!this.isUnstyled()) {
        if (el.$_badgeValue) {
          ...
          if (el.$_badgeValue.length === 1) DomHandler.addClass(badge, 'p-badge-circle');else DomHandler.removeClass(badge, 'p-badge-circle');
