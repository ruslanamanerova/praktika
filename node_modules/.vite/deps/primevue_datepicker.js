import {
  PrimeVueService
} from "./chunk-I33QRUGO.js";
import {
  script as script2
} from "./chunk-LAJPGGQ6.js";
import {
  Base,
  script
} from "./chunk-VGKSFCP3.js";
import {
  BaseStyle,
  ConnectedOverlayScrollHandler,
  DomHandler,
  ObjectUtils as ObjectUtils2,
  Theme,
  ThemeService,
  UniqueComponentId,
  ZIndexUtils,
  primebus
} from "./chunk-HUYBBBAN.js";
import {
  Fragment,
  Teleport,
  Transition,
...
var script3 = {
  ...
  methods: {
    pti: function pti() {
      var isLabelEmpty = ObjectUtils2.isEmpty(this.label);
...
var classes = {
  root: function root(_ref2) {
    ...
    return ["p-badge p-component", {
      "p-badge-circle": ObjectUtils2.isNotEmpty(props.value) && String(props.value).length === 1,
      "p-badge-dot": ObjectUtils2.isEmpty(props.value) && !instance.$slots["default"],
...
var BaseDirective = {
  _getMeta: function _getMeta() {
    return [ObjectUtils2.isObject(arguments.length <= 0 ? void 0 : arguments[0]) ? void 0 : arguments.length <= 0 ? void 0 : arguments[0], ObjectUtils2.getItemValue(ObjectUtils2.isObject(arguments.length <= 0 ? void 0 : arguments[0]) ? arguments.length <= 0 ? void 0 : arguments[0] : arguments.length <= 1 ? void 0 : arguments[1])];
  },
  ...
  _getOptionValue: function _getOptionValue(options) {
    ...
    var fKeys = ObjectUtils2.toFlatCase(key).split(".");
    var fKey = fKeys.shift();
    return fKey ? ObjectUtils2.isObject(options) ? BaseDirective._getOptionValue(ObjectUtils2.getItemValue(options[Object.keys(options).find(function(k) {
      return ObjectUtils2.toFlatCase(k) === fKey;
    }) || ""], params), fKeys.join("."), params) : void 0 : ObjectUtils2.getItemValue(options, params);
  },
  _getPTValue: function _getPTValue() {
    ...
    var getValue = function getValue2() {
      ...
      return ObjectUtils2.isString(value) || ObjectUtils2.isArray(value) ? {
        "class": value
      } : value;
    };
  ...
  _getPTDatasets: function _getPTDatasets() {
    ...
    return _objectSpread2(_objectSpread2({}, key === "root" && _defineProperty2({}, "".concat(datasetPrefix, "name"), ObjectUtils2.toFlatCase(instance.$name))), {}, _defineProperty2({}, "".concat(datasetPrefix, "section"), ObjectUtils2.toFlatCase(key)));
  },
  _getPT: function _getPT(pt) {
    ...
    var getValue = function getValue2(value) {
      ...
      var _key = ObjectUtils2.toFlatCase(key);
  ...
  _usePT: function _usePT() {
    ...
    if (pt !== null && pt !== void 0 && pt.hasOwnProperty("_usept")) {
      ...
      else if (ObjectUtils2.isString(value)) return value;
      else if (ObjectUtils2.isString(originalValue)) return originalValue;
  ...
  _hook: function _hook(directiveName, hookName, el, binding, vnode, prevVnode) {
    ...
    var name = "on".concat(ObjectUtils2.toCapitalCase(hookName));
    var config = BaseDirective._getConfig(binding, vnode);
  ...
  _mergeProps: function _mergeProps() {
    ...
    return ObjectUtils2.isFunction(fn) ? fn.apply(void 0, args) : mergeProps.apply(void 0, args);
  },
  _extend: function _extend(name) {
    ...
    var handleHook = function handleHook2(hook, el, binding, vnode, prevVnode) {
      ...
      var $options = ObjectUtils2.isEmpty($prevInstance) ? _objectSpread2(_objectSpread2({}, options), options === null || options === void 0 ? void 0 : options.methods) : {};
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      var ink = DomHandler.createElement("span", _defineProperty3(_defineProperty3({
        role: "presentation",
        "aria-hidden": true,
        "data-p-ink": true,
...
var _hoisted_17 = ["aria-label", "disabled", "data-p-severity"];
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16, _hoisted_17)), [[_directive_ripple]]);
}
  ...
  methods: {
    ...
    selectDate: function selectDate(dateMeta) {
      ...
      if (this.isSingleSelection()) {
        ...
        modelVal = this.modelValue ? [].concat(_toConsumableArray2(this.modelValue), [date]) : [date];
      } else if (this.isRangeSelection()) {
    ...
    updateModelTime: function updateModelTime() {
      ...
      if (this.isMultipleSelection()) {
        value = [].concat(_toConsumableArray2(this.modelValue.slice(0, -1)), [value]);
      }
    ...
    parseDate: function parseDate(value, format) {
      ...
      value = _typeof5(value) === "object" ? value.toString() : value + "";
      if (value === "") {
        return null;
      }
...
var _hoisted_18 = ["id"];
var _hoisted_27 = ["disabled", "aria-label", "aria-expanded", "aria-controls"];
...
function render10(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    _: 3
  }, 8, ["appendTo", "disabled"])], 16, _hoisted_18);
}
